<div class="widget clearfix contact-box">
    ...
    <div>
        ...
        <ul>
            ...
            <li><i class="fa fa-envelope"></i> <a href="mailto:<?= $contactData['email']?>"><?= $contactData['email']?></a></li>
            <li><i class="fa fa-phone-square"></i> <?= $contactData['phone'] ?></li>
            <li style="white-space: nowrap;"><i class="fa fa-facebook-square"></i> <a href="<?= $contactData['facebook'] ?>" target="_blank"><?= $contactData['facebook'] ?></a></li>
